...
defineProps<{
  activePanel: MainSidebarPanel;
}>();

const emit = defineEmits<{
  panelSelected: [panel: MainSidebarPanel];
}>();
</script>
...
<template>
  <nav class="sidebar" aria-label="Main sidebar">
    ...
    <button
      ...
      :aria-pressed="activePanel === 'task'"
      @click="emit('panelSelected', 'task')"
    >
    ...
    <button
      ...
      @click="emit('panelSelected', 'timeline')"
    >
