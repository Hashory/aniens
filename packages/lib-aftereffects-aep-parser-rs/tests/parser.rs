...
fn fixture(name: &str) -> &'static [u8] {
    match name {
        "BPC-8.aep" => include_bytes!("./data/BPC-8.aep"),
        "BPC-16.aep" => include_bytes!("./data/BPC-16.aep"),
        "BPC-32.aep" => include_bytes!("./data/BPC-32.aep"),
        "ExEn-es.aep" => include_bytes!("./data/ExEn-es.aep"),
        "ExEn-js.aep" => include_bytes!("./data/ExEn-js.aep"),
        "Item-01.aep" => include_bytes!("./data/Item-01.aep"),
        "Layer-01.aep" => include_bytes!("./data/Layer-01.aep"),
        "Property-01.aep" => include_bytes!("./data/Property-01.aep"),
